...
@SpringBootTest
class DeelteGoalSuggestiveActionAnalyzerTest {
    ...
    @Autowired
    public DeelteGoalSuggestiveActionAnalyzerTest(
    ...
    void itSuggestsAGoalWithLatestActivityOlderThanConfiguredInCoachingStyle() {
        ...
        assertEquals(SuggestiveActionType.DELETE_GOAL, suggestiveActionOptional.get().getType());
    }
