...
@SpringBootTest
class DeleteSubgoalSuggestiveActionAnalyzerTest {
    ...
    @Autowired
    public DeleteSubgoalSuggestiveActionAnalyzerTest(
    ...
    void itSuggestsASubgoalWithLatestActivityOlderThanConfiguredInCoachingStyle() {
        ...
        Optional<SuggestiveAction> suggestiveActionOptional = (new DeleteSubgoalSuggestiveActionAnalyzer(subgoal)).analyze();

        assertTrue(suggestiveActionOptional.isPresent());

        SuggestiveAction suggestiveAction = suggestiveActionOptional.get();

        assertEquals(SuggestiveActionType.DELETE_SUBGOAL, suggestiveActionOptional.get().getType());
    }

    @Test
    void itDoesNotSuggestASubgoalWithLatestActivityNewersThanConfiguredInCoachingStyle() {
        // Data clean up
        userDao.truncate();
        goalDao.truncate();
        activityDao.truncate();
